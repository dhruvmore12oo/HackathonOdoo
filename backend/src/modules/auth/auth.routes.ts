...
import { registerSchema, loginSchema, forgotPasswordSchema, resetPasswordSchema, googleLoginSchema } from './auth.schema';
...
router.post('/google', authLimiter, validate(googleLoginSchema), authCtrl.googleLogin);
